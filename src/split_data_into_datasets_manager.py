...
class SplitDatasetManager(object):
    ...
    def prepare(self):
        for cls in self.classes_dir:
            ...
            all_file_names = os.listdir(src_folder)
            ...
            train_file_names = [src_folder + '/' + name for name in train_file_names.tolist()]
            val_file_names = [src_folder + '/' + name for name in val_file_names.tolist()]
            test_file_names = [src_folder + '/' + name for name in test_file_names.tolist()]
